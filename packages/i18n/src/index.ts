...
export const dictionaries = {
  en: {
    ...
    common: { search: "Search tools", copy: "Copy", copied: "Copied", reset: "Reset", download: "Download", clear: "Clear", generate: "Generate", confirm: "Confirm", cancel: "Cancel", continue: "Continue", proceed: "Proceed", close: "Close", invalid: "Please check the value and try again.", onDevice: "Processed on this device", networkRequired: "Network connection required", noResults: "No tools found.", loading: "Loading…", error: "Something went wrong." },
    ...
    password: {
      generator: {
        ...
        downloadConfirmTitle: "Download Plaintext Passwords",
        downloadConfirmDesc: "The generated passwords will be saved to your device as an unencrypted plain text (.txt) file.",
        downloadConfirmNote: "Security Notice: Plain text files are not encrypted on disk. Make sure you store it securely or delete it after importing into your password manager.",
        downloadConfirmAction: "Download File",
  ...
  vi: {
    ...
    common: { search: "Tìm công cụ", copy: "Sao chép", copied: "Đã sao chép", reset: "Đặt lại", download: "Tải xuống", clear: "Xóa", generate: "Tạo", confirm: "Xác nhận", cancel: "Hủy bỏ", continue: "Tiếp tục", proceed: "Thực hiện", close: "Đóng", invalid: "Vui lòng kiểm tra giá trị và thử lại.", onDevice: "Xử lý trên thiết bị này", networkRequired: "Cần kết nối mạng", noResults: "Không tìm thấy công cụ.", loading: "Đang tải…", error: "Đã xảy ra lỗi." },
    ...
    password: {
      generator: {
        ...
        downloadConfirmTitle: "Tải xuống mật khẩu Plaintext",
        downloadConfirmDesc: "Danh sách mật khẩu sẽ được tải xuống máy của bạn dưới dạng tệp văn bản thô (.txt) không mã hóa.",
        downloadConfirmNote: "Lưu ý an toàn: Tệp .txt không được mã hóa trên ổ đĩa. Hãy xóa tệp này sau khi đã lưu vào trình quản lý mật khẩu an toàn.",
        downloadConfirmAction: "Tải xuống tệp",
        downloadCancelAction: "Hủy bỏ",
        reveal: "Hiện kết quả",
        hide: "Ẩn kết quả",
